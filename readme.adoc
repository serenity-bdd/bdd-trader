...
To run this tutorial, you will need https://www.oracle.com/java/technologies/javase/jdk15-archive-downloads.html[JDK 15] or higher,
...
- **bddtrader-app** (containing the Spring Boot application)
- **bddtrader-domain** (containing the domain model used by the application and the tests)
- **bddtrader-test** (containing the Serenity-BDD tests)
